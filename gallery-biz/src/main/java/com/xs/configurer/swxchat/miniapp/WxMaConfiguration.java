package com.xs.configurer.swxchat.miniapp;
...
/**
 * @Auther: zx
 * @Date: 2018/5/16 09:34
 * @Description: 微信小程序配置类
 *  参照：https://github.com/binarywang/weixin-java-miniapp-demo
 */
@Configuration
...
public class WxMaConfiguration {
    ...
    private final WxMaMessageHandler logHandler = (wxMessage, context, service, sessionManager) -> {
        ...
        service.getMsgService().sendKefuMsg(WxMaKefuMessage.newTextBuilder().content("收到信息为：" + wxMessage.toJson())
                .toUser("o4Pge5RMjqS065S6yP7ZpYgHvTpc").build());//.toUser(wxMessage.getFromUser())
    };
